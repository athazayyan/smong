...
export function StudentHero({
  ...
  return (
    <section ref={sectionRef} className="relative isolate overflow-hidden px-4 pb-14 pt-8 sm:px-6 sm:pb-16 sm:pt-10 lg:px-8 lg:pb-20 lg:pt-12">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-8 md:grid-cols-[0.92fr_1.08fr] md:gap-10 lg:min-h-[620px] lg:grid-cols-[0.95fr_1.05fr] lg:gap-12">
        <div className="relative z-10 max-w-2xl text-center lg:text-left">
          ...
          <h1 className="font-heading text-[2.8rem] font-black leading-[0.94] tracking-normal text-ink-900 sm:text-6xl lg:text-7xl">
            {title}
          </h1>
          ...
          <div className="mt-8 flex flex-col gap-3 min-[460px]:flex-row min-[460px]:justify-center lg:justify-start">
            <Link
              href="/siswa/modul"
            ...
            <Link
              href="/siswa/modul"
              className="inline-flex min-h-12 items-center justify-center gap-3 rounded-full border border-purple-700/12 bg-white/72 px-7 py-4 font-heading text-base font-extrabold text-purple-900 shadow-sm backdrop-blur transition hover:bg-white"
            >
          ...
          <div className="mt-8 grid grid-cols-3 gap-2">
            {stats.map((stat) => (
              <div key={stat.id} className="smong-slab-soft border border-purple-700/8 bg-white/62 px-4 py-4 text-center shadow-sm backdrop-blur">
                ...
                <p className="font-heading text-xl font-black leading-none text-ink-900 sm:text-2xl">{stat.value}</p>
                <p className="mt-1 text-[0.58rem] font-black uppercase tracking-[0.08em] text-ink-400 sm:text-[0.64rem] sm:tracking-[0.12em]">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative min-h-[300px] sm:min-h-[340px] md:min-h-[420px] lg:min-h-[540px]">
          ...
          <div data-abstract-float className="absolute left-[4%] top-[32%] max-w-[230px] smong-slab border border-purple-700/10 bg-white/78 p-4 shadow-[0_20px_50px_rgba(47,23,110,0.1)] backdrop-blur sm:left-[10%] sm:p-5">
            ...
            <p className="font-heading text-xl font-black text-ink-900 sm:text-2xl">Jalur aman</p>
