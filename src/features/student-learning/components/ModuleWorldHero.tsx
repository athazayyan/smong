...
export function ModuleWorldHero({ title, description, chapters, progress }: ModuleWorldHeroProps) {
  ...
  return (
    <section className="relative overflow-hidden px-4 pb-16 pt-12 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:min-h-[520px] lg:grid-cols-[1fr_480px]">
        <div className="max-w-3xl">
          ...
          <h1 className="font-heading text-5xl font-black leading-[0.96] text-ink-900 md:text-7xl">
            {title}
          </h1>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            ...
            <div className="inline-flex items-center justify-center gap-3 rounded-full border border-purple-700/10 bg-white/72 px-5 py-4 font-heading text-base font-black text-ink-900 shadow-sm">
        ...
        <div className="relative min-h-[330px]">
          ...
          <div className="absolute left-[8%] top-[28%] smong-slab border border-purple-700/10 bg-white/76 p-5 shadow-[0_20px_54px_rgba(47,23,110,0.1)] backdrop-blur">
          ...
          <div className="absolute right-[8%] top-[18%] w-40 smong-slab-soft border border-purple-700/10 bg-white/70 p-4 text-center shadow-sm backdrop-blur">
          ...
          <div className="absolute bottom-[14%] left-[40%] w-52 smong-slab-soft border border-purple-700/10 bg-white/66 p-4 shadow-sm backdrop-blur">
